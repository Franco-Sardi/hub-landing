...
function Field({ label, error, as: Tag = 'input', children, ...props }) {
  return (
    <div className="flex flex-col gap-1">
      <label className="text-theme-muted text-[10px] font-semibold tracking-[0.2em] uppercase font-condensed">{label}</label>
      <Tag
        {...props}
        className={`w-full bg-theme-card border text-theme text-sm px-3 py-2.5 focus:outline-none transition-colors duration-200 resize-none ${
          error ? 'border-red-500/50' : 'border-theme focus:border-theme-accent'
        }`}
      >
        {children}
      </Tag>
      ...
      <div className="relative max-w-6xl mx-auto px-5 sm:px-8 xl:px-12 w-full py-12 lg:py-16">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-theme-accent text-xs font-semibold tracking-[0.3em] uppercase font-condensed">HUB · Contacto</span>
          </div>
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-3">
            ...
            >
              HABLEMOS DE <span className="text-gradient-electric">TU PRÓXIMO PASO</span>
            </h2>
            ...
            {sent ? (
              ...
              >
                <div
                  ...
                  style={{ borderColor: 'var(--border-accent)', backgroundColor: 'var(--bg-card-alt)' }}
                >
                  <span className="text-theme-accent text-xl" style={{ fontWeight: 800 }}>✓</span>
                </div>
                <div>
                  <h3
                    className="font-display text-theme leading-none mb-2"
                ...
                <button
                  ...
                  className="text-theme-accent text-xs tracking-widest uppercase hover:text-theme transition-colors w-fit border-b pb-px font-condensed"
              ...
              <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-4">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pt-1">
                  ...
                  <button
                    ...
                    className="group flex items-center justify-center gap-2 w-full sm:w-auto px-8 py-3.5 text-xs font-bold tracking-widest uppercase transition-all duration-200 disabled:opacity-50 shrink-0 font-condensed hover:opacity-90"
          ...
          >
            <div className="grid grid-cols-2 lg:grid-cols-1 gap-0">
              {[
                ...
                <div
                  key={item.label}
                  className="flex flex-col py-2.5 border-b lg:last:border-0"
                  style={{ borderColor: 'var(--border)' }}
                >
                  <span className="text-theme-subtle text-[10px] tracking-widest uppercase mb-0.5 font-condensed">{item.label}</span>
